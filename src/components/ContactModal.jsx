          ...
          <div className="modal-content">
            <div className="modal-body d-flex flex-wrap p-0">
              ...
              <div className="col-md-8 p-10">
                ...
                <form>
                  <div className="mb-3">
                    <input type="text" className="form-control border-radius-10" placeholder="Your Name*" required/>
                  </div>
                  <div className="mb-3">
                    <input type="tel" className="form-control border-radius-10" placeholder="Contact number*" required/>
                  </div>
                  <div className="mb-3">
                    <input type="email" className="form-control border-radius-10" placeholder="Email*" required/>
                  </div>
                  <div className="mb-3">
                    <textarea className="form-control border-radius-10" rows="3" placeholder="Message"></textarea>
                  </div>
                  <button type="submit" className="btn bg-btn-primarycl w-100 border-radius-10">Submit <i className="bi bi-arrow-right"></i></button>
                </form>
              </div>
